 ...
 * The generated code is included inside the <div id='site-container'> </div> .. block as the first thing
 */
?>
<?php if ( function_exists( 'cb_has_feedback_message' ) && cb_has_feedback_message() ) : ?>
