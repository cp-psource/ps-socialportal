/* (Not loaded or used, see typography-responsive)*/
( function( $ ) {
	...
	wp.customize.controlConstructor.typography = wp.customize.Control.extend( {
		...
		ready: function() {
			...
			control.setting.bind( function( value ) {
				...
				if ( $fontSizeControl.length && value['font-size'] && value['font-size'] != $fontSizeControl.val() ) {
					$fontSizeControl.val( value['font-size'] );
				}

				if ( $lineHeightControl.length && value['line-height'] && value['line-height'] != $lineHeightControl.val() ) {
					$lineHeightControl.val( value['line-height'] );
				}
