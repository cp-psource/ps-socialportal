...
?>
<h4 class="bp-screen-reader-text"><?php _e( 'Manage Group Settings', 'social-portal' ); ?></h4>
...
<?php if ( function_exists( 'bp_groups_get_group_types' ) && $group_types = bp_groups_get_group_types( array( 'show_in_create_screen' => true ), 'objects' ) ): ?>
	...
	<fieldset class="group-create-types">
		...
		<p><?php _e( 'Wähle den Typen aus, zu dem diese Gruppe gehören soll.', 'social-portal' ); ?></p>

		<?php foreach ( $group_types as $type ) : ?>
			<div class="checkbox form-text-secondary">
