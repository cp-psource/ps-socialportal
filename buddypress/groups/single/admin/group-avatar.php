...
<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
	...
	<?php if ( bp_get_group_has_avatar() ) : ?>
		<p><?php _e( "Wenn Du das vorhandene Gruppenprofilbild entfernst, aber kein neues hochladen möchtest, klicke auf die Schaltfläche Gruppenprofilbild löschen.", 'social-portal' ); ?></p>

		<?php bp_button( array( 'id' => 'delete_group_avatar', 'component' => 'groups', 'wrapper_id' => 'delete-group-avatar-button', 'link_class' => 'edit', 'link_href' => bp_get_group_avatar_delete_link(), 'link_title' => __( 'Gruppenprofilbild löschen', 'social-portal' ), 'link_text' => __( 'Gruppenprofilbild löschen', 'social-portal' ) ) ); ?>
...
<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
	...
	<h4><?php _e( 'Profilbild beschneiden', 'social-portal' ); ?></h4>
