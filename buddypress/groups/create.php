...
<div id="buddypress">
	...
	<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form group-setup-form" enctype="multipart/form-data">
		...
		?>
		<div class="<?php cb_bp_dir_item_nav_css_class( array( 'component' => 'activity', 'type'=> 'primary' , 'class' => 'bp-groups-create-nav' ) );?>  ">
			<div class="<?php cb_bp_dir_item_tabs_css_class( array( 'component'=> 'groups', 'type'=> 'primary', 'class' => ' no-greedy-nav no-ajax bp-groups-create-nav-tabs' ) ); ?>" id="group-create-tabs" role="navigation">
				<ul>
		...
		<div class="item-body <?php bp_groups_current_create_step(); ?>" id="group-create-body">
		...
		<?php /* Group creation step 1: Basic group details */ ?>
			<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
				...
				<h2 class="bp-screen-reader-text"><?php
					...
					_e( 'Gruppendetails', 'social-portal' );
					?>
				</h2>
				<?php
				...
				<fieldset class="group-settings-privacy group-create-privacy">
					...
					<div class="radio">
						<label for="group-status-public">
						    <input type="radio" name="group-status" id="group-status-public" value="public"<?php if ( 'public' == bp_get_new_group_status() || !bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> /> 
							<strong><?php _e( 'Dies ist eine öffentliche Gruppe', 'social-portal' ); ?></strong>
						</label>
						...
						<ul id="hidden-group-description">
							<li><?php _e( 'Nur Benutzer, die eingeladen sind, können der Gruppe beitreten.', 'social-portal' ); ?></li>
				...
				<?php if (  function_exists( 'bp_groups_get_group_types' ) && $group_types = bp_groups_get_group_types( array( 'show_in_create_screen' => true ), 'objects' ) ): ?>
					...
					<fieldset class="group-create-types">
						...
						<?php foreach ( $group_types as $type ) : ?>
							<div class="form-text-secondary checkbox ">
			...
			<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
				...
				<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<h4><?php _e( 'Gruppen-Profilbild zuschneiden', 'social-portal' ); ?></h4>

					<img src="<?php bp_avatar_to_crop(); ?>" id="avatar-to-crop" class="avatar" alt="<?php esc_attr_e( 'Gruppen-Profilbild zum Zuschneiden', 'social-portal' ); ?>" />

					<div id="avatar-crop-pane">
						<img src="<?php bp_avatar_to_crop(); ?>" id="avatar-crop-preview" class="avatar" alt="<?php esc_attr_e( 'Gruppen-Profilbild Vorschau', 'social-portal' ); ?>" />
					</div>
