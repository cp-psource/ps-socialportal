 ...
 * Directory search
 *
 * Loads directory search for each component.
 *
...
if ( bp_is_members_directory() ) {
	$dir_nav_template = 'members/directory/search.php';
} elseif ( bp_is_activity_directory() ) {
	$dir_nav_template = 'activity/directory/search.php';
} elseif ( bp_is_groups_directory() ) {
	$dir_nav_template = 'groups/directory/search.php';
} elseif ( bp_is_blogs_directory() ) {
	$dir_nav_template = 'blogs/directory/search.php';
}
 ...
 */
$located = apply_filters( 'cb_bp_dir_search_form_template', $located );// it is the absolute path to the file.
