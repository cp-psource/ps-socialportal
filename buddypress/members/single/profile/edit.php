<?php
/**
 * BuddyPress - Member - Profile - Edit
 *
...
?>
	<div class="bp-edit-profile styled-rounded-fieldset">
		<?php if ( bp_has_profile( 'profile_group_id=' . bp_get_current_profile_group_id() ) ) : ?>
			...
			<?php while ( bp_profile_groups() ) : bp_the_profile_group(); ?>
				...
				<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
					...
					<h4 class="profile-editing-title">
						<?php
						/* translators: %s: displayed user name */
                        printf( __( "Bearbeite '%s'", "social-portal" ), bp_get_the_profile_group_name() ); ?>
					</h4>
						...
						<div<?php bp_field_css_class( 'editfield' ); ?>>
							...
							<?php if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
								...
								<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
                                    ...
                                    printf( __( 'This field can be seen by: <span class="current-visibility-level">%s</span>', 'social-portal' ), bp_get_the_profile_field_visibility_level_label() ) ?>
									<a href="#" class="visibility-toggle-link" title="<?php _e( 'Ändern', 'social-portal' ); ?>"><i class="fa fa-cog"></i>
									</a>
								</p>
							...
							<?php else : ?>
								...
								<div class="field-visibility-settings-notoggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
									<?php
									/* translators: %s: field visibility */
                                    printf( __( 'Dieses Feld kann gesehen werden von: <span class="current-visibility-level">%s</span>', 'social-portal' ), bp_get_the_profile_field_visibility_level_label() ) ?>
								</div>
