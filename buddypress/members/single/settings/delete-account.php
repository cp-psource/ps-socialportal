<?php
/**
 * BuddyPress - Member - Settings - Delete Account
 *
...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form form-settings form-settings-delete" method="post">
