<?php
/**
 * BuddyPress - Member - Settings - Profile
 *
...
<form action="<?php echo trailingslashit( bp_displayed_user_domain() . bp_get_settings_slug() . '/profile' ); ?>" method="post" class="standard-form form-settings form-settings-profile" id="settings-form">
